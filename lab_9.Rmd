...
**Given the linearity of the data, the relatively normal residuals, and consistent variance, we can consider a linear model to be appropriate for this data.**
```{r}
